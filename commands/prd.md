...
You are running the supertools-design `prd` workflow.
...
"The `prd` workflow isn't implemented yet — it's a placeholder in the supertools-design v0.1 scaffold. Run `/supertools-design:status` to see the overall flow."
